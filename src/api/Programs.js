...
const normalizeProgram = (program, lang = 'ar') => {
  ...
  return {
    ...
    language: localizeValueDeep(p.language, lang) || '',
    schedule: localizeValueDeep(p.schedule, lang) || {},
    Mandatoryrequirements: localizeValueDeep(p.Mandatoryrequirements, lang),
    curriculum: localizeValueDeep(p.curriculum, lang),
    Learningoutcomes: localizeValueDeep(p.Learningoutcomes, lang),
    targetJobs: localizeValueDeep(p.targetJobs, lang),
    exitPoints: localizeValueDeep(p.exitPoints, lang),
    certifications: localizeValueDeep(p.certifications, lang),
    felxabilty: localizeValueDeep(p.felxabilty, lang),
