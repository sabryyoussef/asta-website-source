...
export default function Footer() {
  ...
  const footerData = {
    contactInfo: [
      ...
      { icon: 'fa-envelope', text: 'info@vetbrains.edu.eg', href: 'mailto:info@vetbrains.edu.eg', target: '_blank' }
    ],
          ...
          <div>
            <div className="mb-8">
              ...
              <div className="relative rounded-lg overflow-hidden shadow-lg border border-white/20">
                <a
                  href="https://maps.google.com/?q=451+Haram+Street,+Giza,+Egypt"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
        ...
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-gray-400 text-sm text-center md:text-right">
              {isRTL ? 'جميع الحقوق محفوظة' : 'All rights reserved'} - {isRTL ? 'عقول بيطرية' : 'Vet Brains'} &copy; {new Date().getFullYear()}
             </div>
