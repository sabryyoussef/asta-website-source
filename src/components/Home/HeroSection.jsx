...
export default function Hero() {
  ...
  return (
    <div className="relative pb-[64px] pt-[48px] overflow-hidden">
      ...
      <button
        type="button"
        onClick={() => setActiveIndex((prev) => (prev + 1) % SLIDE_COUNT)}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-white/80 hover:bg-white text-gray-800 rounded-full p-3 shadow-lg transition-all duration-200 hover:scale-110"
